...
export default function PhoneDemoPage() {
  ...
  const flashcards = [
    ...
    {
      question: "What is the concept of \"ground truth\" in AI product development?",
      options: [
        "Accurate labeled data for training",
    ...
    {
      question: "What is a key ethical consideration when developing AI products?",
      options: [
    ...
    {
      question: "What is \"model drift\" in AI products?",
      options: [
        "A design trend in UI/UX",
        "Degradation of model performance over time",
        "Moving from one cloud provider to another",
        "Change in product leadership"
      ],
      correct: 1
    },
    {
      question: "What is an effective approach to gathering user feedback for AI products?",
      options: [
        "Only track technical metrics",
        "Wait until full product launch",
        "Rely only on AI predictions",
        "Continuous user testing with diverse feedback channels"
      ],
      correct: 3
    },
    {
      question: "What is \"explainability\" in AI product management?",
      options: [
        "Internal documentation process",
        "Ability to understand why AI made a decision",
    ...
    {
      question: "What is a primary benefit of A/B testing in AI product development?",
      options: [
        "Reduces development costs",
        "Eliminates the need for user feedback",
        "Validates performance improvements with real users",
        "Simplifies the tech stack"
      ],
      correct: 2
    },
    {
      question: "What's the recommended approach for launching a new AI feature?",
      options: [
        "Big bang release to all users",
        "Phased rollout with monitoring",
        "Wait for 100% accuracy",
        "Release only after competitor launches"
      ],
      correct: 1
    }
  ];
  ...
  return (
    <div className={`min-h-screen ${isDemoMode ? 'mobile-demo-view' : ''}`}>
              ...
              {currentScreen === 'loading' && (
                <div className="h-full bg-yellow-50 flex flex-col items-center justify-center">
                  <div className="w-32 h-32 mb-8">
                    <img src="/LOGO.jpg" alt="JobHatch Logo" className="w-full h-full rounded-3xl" />
                  </div>
                  <div className="w-48 h-2 bg-gray-200 rounded-full overflow-hidden mb-4">
                    <div className="h-full bg-blue-400 rounded-full animate-pulse" style={{width: '100%', animation: 'loading 2s ease-in-out forwards'}}></div>
                  </div>
                  ...
                  <div className="flex-1 overflow-y-auto p-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-800 mb-1">Product Management Basics</h4>
                          <div className="flex gap-4 text-xs text-gray-500 mb-2">
                            <span className="flex items-center gap-1">
                              <i className="fas fa-signal"></i> Beginner
                            </span>
                            <span className="flex items-center gap-1">
                              <i className="far fa-clock"></i> 15 min
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <div className="flex-1 h-1 bg-gray-200 rounded-full overflow-hidden">
                      ...
                      <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-800 mb-1">Data Analytics for PMs</h4>
                          <div className="flex gap-4 text-xs text-gray-500 mb-2">
                            <span className="flex items-center gap-1">
                              <i className="fas fa-signal"></i> Intermediate
                            </span>
                            <span className="flex items-center gap-1">
                              <i className="far fa-clock"></i> 25 min
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                            <div className="flex-1 h-1 bg-gray-200 rounded-full overflow-hidden">
                              <div className="h-full w-1/6 bg-blue-400 rounded-full"></div>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-800 mb-1">UX Fundamentals</h4>
                        <div className="flex gap-4 text-xs text-gray-500 mb-2">
                          <span className="flex items-center gap-1">
                            <i className="fas fa-signal"></i> Beginner
                          </span>
