...
const InvestorIntakePage: React.FC = () => {
  ...
  const handleFormSubmit = (formData: any) => {
    console.log('[INVESTOR-INTAKE] Form data submitted:', formData);
    
    // Save investor intake data to localStorage
    localStorage.setItem('investor_intake_data', JSON.stringify({
      ...formData,
      timestamp: new Date().toISOString(),
      source: 'onboarding_investor_intake'
    }));
  };

  const handleSubmissionSuccess = () => {
    console.log('[INVESTOR-INTAKE] ✅ Submission successful');
  ...
  const handleSubmissionError = (error: string) => {
    console.error('[INVESTOR-INTAKE] ❌ Submission error:', error);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span className="font-medium">
                {user?.username || user?.email || 'Investor'}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Your investor profile has been successfully created. You'll be redirected to continue your setup.
              </p>
...
export default InvestorIntakePage; 